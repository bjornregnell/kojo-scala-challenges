...
0. [Clone](https://bitbucket.org/bjornregnell/scaboo/overview#clone) or [fork](https://bitbucket.org/bjornregnell/scaboo/fork) this repo e.g. using [Sourcetree](http://www.sourcetreeapp.com/)
