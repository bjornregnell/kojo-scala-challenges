...
\usepackage[italian]{babel}	% hyphenation and content headings  %%LOCALIZE
...
\usepackage{listings}
\lstset{literate=%
%swedish, german, danish and italian special letters
{Å}{{\AA}}1
{Ä}{{\"A}}1
{Ö}{{\"O}}1
{Ü}{{\"U}}1
...
\title{\fontsize{40}{40}\bf\sffamily\selectfont Sfide con Kojo} %%%LOCALIZE
