...
Schreibe diese Worte in Kojos Skript-Editor-Fenster:
...
\chapter{Zeichne eine Figur}
\begin{multicols}{2}
\section*{\color{BrickRed}Aufgabe:}
Zeichne eine einfache Figur.
...
Die Position der Maus im Zeichenfenster, kannst Du links unter dem Programmbearbeiter ablesen:
...
\chapter{Alternative mit \lstinline{if}}Mit einer \lstinline{if}-Anweisung kann man den Computer zwischen zwei Alternativen wählen lassen.
...
\chapter{Verändere das Pong-Spiel}
\begin{multicols}{2}
\section*{\color{BrickRed}Aufgabe:}
