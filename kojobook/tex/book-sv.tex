...
\usepackage[swedish]{babel}	% hyphenation and content headings  %%LOCALIZE
...
\title{\fontsize{40}{40}\bf\sffamily\selectfont Uppdrag med Kojo} %%%LOCALIZE
\author{Redaktör: Björn Regnell \\ \bf www.lth.se/programmera} %%%LOCALIZE
\titlepic{\includegraphics[height=8cm]{../img/cover}}
\date{}
