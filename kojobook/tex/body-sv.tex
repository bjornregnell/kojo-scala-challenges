...
\begin{tikzpicture}[overlay]
\node at (21.0cm,0.0cm) {\includegraphics[width=12.0cm]{../img/polygons-circle.png}};
\end{tikzpicture}
...
\begin{tikzpicture}[overlay]
\node at (22.0cm,-2.5cm) {\includegraphics{../img/horse1-a.png}};
\end{tikzpicture}
...
\item {Spåra programmet med den brandgula playknappen och undersök varje steg.}
